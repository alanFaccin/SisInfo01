...
<title>Sistemas de Informação - Relação Escolaridade x Salário</title>
<!-- Bootstrap -->
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        // Set chart options
        var options = {
            'title' : 'Relação Escolaridade x Salário ', //title which will be shown right above the Google Pie Chart
